...
#dest=[pair[3],pair[2]]
print(1)
G2 = ox.graph_from_bbox(40.77, 40.70, -73.88,-73.99, network_type='drive')
#G3 = ox.graph_from_bbox(40.75, 40.70, -73.75,-73.81, network_type='drive')
#ox.plot_graph(G2)
origin_node = ox.nearest_nodes(G2, orig[1],orig[0])
#origin_node2 = ox.nearest_nodes(G3, orig[1],orig[0])
destination_node = ox.nearest_nodes(G2, dest[1],dest[0])
...
print(route)
#print(route2)
route1_length = sum(ox.utils_graph.get_route_edge_attributes(G2, route, 'length'))
